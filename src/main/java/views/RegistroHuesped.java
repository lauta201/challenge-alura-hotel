...
public RegistroHuesped(Integer idReserva)  {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					guardarHuesped();
					JOptionPane.showMessageDialog(contentPane,"Usuario guardado con exito");
	...
	public void guardarHuesped() throws SQLException {
		...
		Usuario registrarHuesped = new Usuario(nombre, apellido,java.sql.Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(),  telefono, idReserva);
		
			usuarioController.guardar(registrarHuesped);
