...
public class ReservasView extends JFrame {
	...
	public ReservasView()  {
		...
		panel_1.setBounds(393, 0, 517, 560);
		...
		imagenFondo.setBounds(12, 140, 488, 409);
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAtras.setBackground(new Color(102,102,102));
		...
		txtFechaSalida.setBorder(new LineBorder(new Color(76,76,77), 0));
		...
		txtFormaPago.setBorder(new LineBorder(new Color(76,76,77), 1, true));
		...
		btnsiguiente.setBackground(new Color(102,102,102));
	...
	public void calcularValor(JDateChooser fechaEntrada, JDateChooser fechaSalida ) {
		...
		if(fechaEntrada.getDate() !=null && fechaEntrada.getDate() != null) {
		
			Calendar diaEntrada = fechaEntrada.getCalendar();
			Calendar diaSalida = fechaSalida.getCalendar();
			int dias= -1;
			int valorDia = 100;
			int ValorReserva;
		 
			while (diaEntrada.equals(diaSalida) || diaEntrada.before(diaSalida)) {
			 dias ++;
			 diaEntrada.add(Calendar.DATE, 1);
			}
		 
		 
			ValorReserva = dias * valorDia ;
			String valor = Integer.toString(ValorReserva);
	...
	private void guardarReserva() {
		...
		RegistroHuesped regitrarUsuario = new RegistroHuesped(nuevaReserva.getId());
		regitrarUsuario.setVisible(true);
		dispose();
